...
public class ForgetPassUserController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		conncc = MySqlConnectionUser.MySqlConnectionUserConnector();
	}
	...
	public void getPassword(ActionEvent e) throws Exception {
		...
		ResultSet rs2;
		String query2 = "select password from userdata where unique_id = ? and phonenumber = ?";
	...
	public void Login(ActionEvent e) throws Exception {
		...
		ResultSet rs3;
		String query3 = "select password from userdata where unique_id = ? and phonenumber = ? and password = ?";
